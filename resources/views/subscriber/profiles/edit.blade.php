    ...
    <form method="POST" action="{{route('profiles.update', $profile)}}" enctype="multipart/form-data" class="form-article">
        ...
        <div class="content-create-article">
            ...
            <div class="input-content">
                ...
                <input type="text" name="name" placeholder="Escribe tu nombre completo" value="{{$profile->user->name}}" autofocus>
            ...
            <div class="input-content">
                ...
                <input type="text" name="email" placeholder="Correo eléctronico" value="{{$profile->user->email}}" autofocus>
